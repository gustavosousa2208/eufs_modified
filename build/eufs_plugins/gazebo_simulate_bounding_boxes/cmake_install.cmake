# Install script for directory: /home/gustavo/eufs_sim_teste/eufs_sim/eufs_plugins/gazebo_simulate_bounding_boxes
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/eufs_plugins" TYPE DIRECTORY FILES "/home/gustavo/eufs_sim_teste/eufs_sim/eufs_plugins/gazebo_simulate_bounding_boxes/config" FILES_MATCHING REGEX "/[^/]*\\.yaml$")
endif()
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib" TYPE SHARED_LIBRARY FILES "/home/gustavo/eufs_sim_teste/build/eufs_plugins/gazebo_simulate_bounding_boxes/libgazebo_simulate_bounding_boxes.so")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/libgazebo_simulate_bounding_boxes.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/libgazebo_simulate_bounding_boxes.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/libgazebo_simulate_bounding_boxes.so"
